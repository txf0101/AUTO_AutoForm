...
def _default_gateway_tools() -> tuple[GatewayToolSpec, ...]:
    return (
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.status.autoform_status_snapshot",
        ...
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.project.autoform_discover_installation",
            execution_class=R5_EXECUTION_CLASS_READ_ONLY,
            risk_level="low",
        ),
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.scripts.autoform_script_catalog",
            execution_class=R5_EXECUTION_CLASS_READ_ONLY,
            risk_level="low",
        ),
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.scripts.autoform_script_run",
        ...
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.project.autoform_resolve_project",
            execution_class=R5_EXECUTION_CLASS_PLANNING,
            risk_level="low",
        ),
        GatewayToolSpec(
        ...
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.project.autoform_import_geometry_to_new_project",
            execution_class=R5_EXECUTION_CLASS_GUARDED_GUI,
            risk_level="medium",
            default_arguments={
        ...
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.quicklink.autoform_list_exported_geometry",
            execution_class=R5_EXECUTION_CLASS_READ_ONLY,
            risk_level="low",
        ),
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_gui_window_snapshot",
            execution_class=R5_EXECUTION_CLASS_READ_ONLY,
            risk_level="low",
        ),
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_computer_use_probe",
            execution_class=R5_EXECUTION_CLASS_READ_ONLY,
            risk_level="low",
        ...
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_gui_control_demo",
            execution_class=R5_EXECUTION_CLASS_GUARDED_GUI,
            risk_level="medium",
        ...
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_r12_project_view_demo",
            execution_class=R5_EXECUTION_CLASS_GUARDED_GUI,
            risk_level="medium",
            default_arguments={"execute": False, "example_name": "Solver_R13"},
            controlled_arguments=("execute",),
        ),
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_result_query_capabilities",
            execution_class=R5_EXECUTION_CLASS_READ_ONLY,
            risk_level="low",
        ),
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_result_gui_evidence",
            execution_class=R5_EXECUTION_CLASS_READ_ONLY,
            risk_level="low",
        ),
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_result_route_task",
            execution_class=R5_EXECUTION_CLASS_PLANNING,
            risk_level="low",
        ),
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_result_plan_review",
            execution_class=R5_EXECUTION_CLASS_PLANNING,
            risk_level="low",
        ),
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_result_readiness",
            execution_class=R5_EXECUTION_CLASS_READ_ONLY,
            risk_level="low",
        ),
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_result_open_latest",
            execution_class=R5_EXECUTION_CLASS_GUARDED_GUI,
            risk_level="medium",
        ...
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_result_open_project",
            execution_class=R5_EXECUTION_CLASS_GUARDED_GUI,
            risk_level="medium",
            default_arguments={"execute": False, "screenshot": False},
            controlled_arguments=("execute", "screenshot"),
        ...
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_result_show_variable",
            execution_class=R5_EXECUTION_CLASS_GUARDED_GUI,
            risk_level="medium",
        ...
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_result_set_view",
            execution_class=R5_EXECUTION_CLASS_GUARDED_GUI,
            risk_level="medium",
            default_arguments={"execute": False, "verify_screenshot": False},
            controlled_arguments=("execute", "verify_screenshot"),
        ...
        GatewayToolSpec(
            ...
            source_layer="autoform_agent.mcp_tools.gui.autoform_result_view_evidence",
            execution_class=R5_EXECUTION_CLASS_GUARDED_GUI,
            risk_level="medium",
