...
MODULE_COVERAGE = [
    ...
    },
    {
        ...
        "evidence": ["systemConfigFile.xml", "workspace log files", "installation discovery"],
    },
    {
    ...
    },
    {
        ...
        "status": "implemented-inventory-and-preview",
        "tools": [
        ...
        "evidence": ["bin directory", "helpLinks.cfg", "report templates", "GUI logs", "command preview tests"],
    },
    {
        "module": "AF_API",
    ...
    },
    {
        ...
        "status": "implemented-specs-kinematic-and-full-execution",
        "tools": [
