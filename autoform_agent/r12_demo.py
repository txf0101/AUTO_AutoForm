"""R12 high-level visible AutoForm project view demo.

This module connects the already-tested project opener and view shortcut
controls into one auditable acceptance slice: open an official example project,
switch to top view, then switch back to isometric view.
"""
