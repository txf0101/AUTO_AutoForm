...
def autoform_status_snapshot(
    ...
    return {
        ...
        "evidence": {
            ...
            "installation_probe": "autoform_core.paths.discover_installations",
            "queue_probe": "autoform_core.queue.queue_health_check",
            "quicklink_probe": "autoform_core.quicklink.list_quicklink_exports",
            "log_probe": "autoform_core.diagnostics.collect_recent_autoform_logs",
            "coverage_probe": "autoform_core.coverage.module_coverage_matrix",
        },
    }
...
def _service_defaults() -> dict:
    ...
    return {
        ...
        "frontend": {
            ...
            "evidence": "start_autoform_agent.ps1 BridgePort/FrontendPort and apps/workbench/README.md",
        },
    }
