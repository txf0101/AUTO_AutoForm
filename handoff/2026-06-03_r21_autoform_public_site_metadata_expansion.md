...
真实原始元数据 JSON 保存在 `enterprise_data/raw_data/manual_samples/r21_autoform_public_site_metadata_20260603/`，该目录被 raw_data `.gitignore` 忽略。

| 本地原始元数据文件 | 标题 | SHA256 checksum |
| --- | --- | --- |
| `enterprise_data/raw_data/manual_samples/r21_autoform_public_site_metadata_20260603/autoform_public_page_metadata_001_autoform_forming_20260603.json` | `AutoForm Forming` | `f1735a268dac74adcd3b5f2cbc8807c169942f7c1eb51d1943e06012c601b2e9` |
| `enterprise_data/raw_data/manual_samples/r21_autoform_public_site_metadata_20260603/autoform_public_page_metadata_002_autoform_formingsolver_20260603.json` | `AutoForm-FormingSolver` | `76a19c08675c584fb3f36ee0cf673bcf78aa47dcbce7a9889c4782413cb00cc4` |
| `enterprise_data/raw_data/manual_samples/r21_autoform_public_site_metadata_20260603/autoform_public_page_metadata_003_biw_assembly_process_chain_20260603.json` | `BiW Assembly Process Chain` | `279803f9179f557035a745968ffca8fc06aa3014917bb9ae1419bbbbf3dc2675` |

Manifest 写入：`enterprise_data/raw_data/manifests/2026-06-03_r21_autoform_public_site_metadata_manifest.csv`。

## R14 清洗结果

R14 文件：`enterprise_data/r21_autoform_public_site_metadata_samples.jsonl`。

清洗报告：`enterprise_data/r14_cleaning_reports/r21_autoform_public_site_metadata_cleaning_report.json`。
...
R15 候选卡：`enterprise_data/r21_autoform_public_site_cards.candidate.json`。
...
R16 EvidenceBundle：`enterprise_data/r21_autoform_public_site_evidence_bundle.sample.json`。
...
已更新 `enterprise_data/source_whitelist.csv` 中 `source_autoform_public_site_metadata`：
