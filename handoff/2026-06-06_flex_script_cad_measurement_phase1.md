...
- `apps/workbench/app.js` 展示 `cad_measurement_result`、parser、bbox、length、width、thickness、blocked reason、evidence_dir 和 filename candidate，并把候选值按候选字段传回上下文。
...
```powershell
node apps\workbench\tests\smoke-test.mjs
```
